...
--ADD fk_books_users_books  FOREIGN KEY (book_id)  REFERENCES books (book_id),

--books-- 
--ALTER TABLE books 
--ADD fk_books_people  FOREIGN KEY (author_people_id)  REFERENCES people (people_id),

--time 
--ALTER TABLE time
--CONSTRAINT fk_time_users  FOREIGN KEY (user_id)  REFERENCES users (user_id),
	--CONSTRAINT fk_time_books  FOREIGN KEY (book_id)  REFERENCES books (book_id)
